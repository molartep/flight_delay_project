...
```{r plots, fig.height=7, fig.width=10, fig.cap="Predictors vs Response Variable"}
grid.arrange(
  ggplot_AWND.origin,
  ggplot_AWND.dest,
  ggplot_PRCP.origin,
